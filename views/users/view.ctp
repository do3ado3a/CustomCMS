...
<div class="related">
	...
	<tr>
		...
		<th><?php __('Tags'); ?></th>
		<th><?php __('Type'); ?></th>
		<th><?php __('AttachmentName'); ?></th>
		<th><?php __('AttachmentType'); ?></th>
		<th><?php __('AttachmentLocation'); ?></th>
		<th><?php __('AttachmentSize'); ?></th>
		<th><?php __('AttachmentWidth'); ?></th>
		<th><?php __('AttachmentHeight'); ?></th>
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td><?php echo $post['status_id'];?></td>
			<td><?php echo $post['published'];?></td>
			<td><?php echo $post['tags'];?></td>
			<td><?php echo $post['type'];?></td>
			<td><?php echo $post['attachmentName'];?></td>
			<td><?php echo $post['attachmentType'];?></td>
			<td><?php echo $post['attachmentLocation'];?></td>
			<td><?php echo $post['attachmentSize'];?></td>
			<td><?php echo $post['attachmentWidth'];?></td>
			<td><?php echo $post['attachmentHeight'];?></td>
