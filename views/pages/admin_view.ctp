<div class="options"><?php echo $html->link(__('edit', true), array('action'=>'edit', $pages['Page']['id'])); ?> | <?php echo $html->link(__('delete', true), array('action'=>'delete', $page['Page']['id']), array('class' => 'delete'), sprintf(__('Are you sure you want to delete # %s?', true), $page['Page']['id'])); ?></div>
...
<h2> <?php echo $page['Page']['subpage_count']; ?> Comments</h2>
